...
ingredients_list = st.multiselect(
    ...
    pd_df['FRUIT_NAME'],  # Use the actual list of fruit names
    max_selections=5
)
...
if ingredients_list:
    ...
    for fruit_chosen in ingredients_list:
        ...
        # Making the API request and checking if it's successful
        ...
        if fruityvice_response.status_code == 200:
            try:
                ...
                st.error("API did not return valid JSON. Please try again later.")
        else:
